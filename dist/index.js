(() => {
    ...
    if (breakpoint.matches) {
      ...
      swiperComponents.forEach((component) => {
        ...
        if (swiperElement) {
          ...
          console.log(`Pas de swiper trouv\xE9`);
        }
      });
  ...
  var panels = $("[panel-item]");
  var dots = $(".panel_dot_item");
  var panelContents = document.querySelectorAll(".panel_content_inner");
      ...
      if (index !== panels.length - 1) {
        ...
        gsapWithCSS.to(panel, {
          ...
          scrollTrigger: {
            ...
            scrub: true,
            // Permet un changement progressif de l'opacit̩
            onLeaveBack: () => {
            },
            onLeave: () => {
            }
